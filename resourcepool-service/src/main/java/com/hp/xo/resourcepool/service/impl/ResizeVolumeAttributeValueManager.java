...
@Service("resizeVolumeAttributeValueManager")
public class ResizeVolumeAttributeValueManager extends
	...
	public Map<String, Object> getExtval(String attributeName, String sessionkey, Map<String, Object[]> valueParam) {
		...
		if(EXTERNAL_DISKOFFERINGID.equalsIgnoreCase(attributeName)){
