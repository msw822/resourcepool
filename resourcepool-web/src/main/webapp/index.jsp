    ...
    <body>
                    ...
                    <div class="steps">
                        ...
                        <div class="step setup" wizard-step-id="setup">
                            <div class="content">
                                ...
                                <div class="section select-zone">
                                    ...
                                    <div class="select-area">
                                        ...
                                        <select name="zoneid" class="required zone" > 
                                            <%-- <option default="default" value="1" ><fmt:message key="label.select.a.zone"/></option> --%>
                                        </select>
                                        <select id="hostid" name="hostid" class="required host" style="display:none">
                   	 					</select> 
                                    </div>
                                </div>
                                <!-- Select template -->
                         	...
                         	<div class="section custom-size custom-disk-size apply-time-length" id ="apply-time-length" style="display: block;">
                         			<!--  <h3>选择申请时长</h3>  -->
                                     <label>申请时长</label> 
                                    <!-- Slider -->
                        ...
                        <div class="step review" wizard-step-id="review">
                            ...
                            <div class="content">
								...
								<div id='applyMonths' class="select odd">
									<div  class="name">
										<span>申请时长</span>
									</div>
									<div class="value">
								...
								<div id='applyReason' class="select applyReason" style="display: block;">
									<div class="name">
										<span>申请理由(必填)</span>
									</div>
									<div class="value">
        ...
        <!-- jQuery -->
         <script type="text/javascript">
	    	...
	    	var webURL = '<%=webURL%>';
	    	//alert("index.jsp-servicePath--"+servicePath);
	    	
	    	//定时与后台进行交互，防止超时
	    	/* setInterval("keepSessionValid();",3*60*1000);
        ...
        <script type="text/javascript" src="scripts/ui-custom/instanceWizard02.js?t=<%=now%>"></script>
        <script type="text/javascript" src="scripts/instanceWizard.js?t=<%=now%>"></script>
        <script type="text/javascript" src="scripts/instanceWizard02.js?t=<%=now%>"></script>
		...
		<script type="text/javascript" src="scripts/workOrder.js?t=<%=now%>"></script>
		<script type="text/javascript" src="scripts/workOrderToDo.js?t=<%=now%>"></script>
		<script type="text/javascript" src="scripts/workOrderDue.js?t=<%=now%>"></script>
		...
		function pageLoadCompleteCallback()
		{
			...
			var avmon='<div id="wrap"><div id="avmontop" class="avmontop"><div class="fixed">'
			+ '<a href="'+'<%=webURL%>'+'"><div class="Avmon_back_gif">'
			+'<img id="Avmon_back_img" src="${pageContext.request.contextPath}/images/back.png" ' 
			+'onmouseover="mouseover(\'${pageContext.request.contextPath}\');"></div></a>'
			+'<div id="aa" class="MainTitle f28px LineH12"style="font-size: 28px;line-height: 12px !important; font-family: \'Microsoft yahei\',\'微软雅黑\',\'Lato\', Helvetica,Tahoma,Verdana,Arial,sans-serif ">资源管理</div></div></div></div>';
...
<script src="${pageContext.request.contextPath}/scripts/avmon_back_gif.js"></script>
