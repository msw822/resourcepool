...
/*add on resourcepool below*/
'label.apply.immediately': '<fmt:message key="label.apply.immediately" />',
'message.delete.workorder': '<fmt:message key="message.delete.workorder" />',
'label.action.delete.workorder': '<fmt:message key="label.action.delete.workorder" />'
};
</script>
