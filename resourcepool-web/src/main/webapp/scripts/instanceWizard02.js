...
(function($, cloudStack) {
    var zoneObjs, hypervisorObjs, featuredTemplateObjs, communityTemplateObjs, myTemplateObjs, featuredIsoObjs, community, networkObjs,hostObjs;
        ...
        steps: [
            ...
            function(args) {
                if (args.initArgs.pluginForm != null && args.initArgs.pluginForm.name == "vpcTierInstanceWizard") { //from VPC Tier chart
                   ...
                   // var te1  = $("select[name='zoneid'] option:selected").val();
                  // alert(te1);
                   // var te  = $("select[name='zoneid']").val();
//                    $.ajax({                                    	                                    	
...
//                    });
        ...
        action: function(args) {
            ...
            if(""!=args.data.hostid && undefined!=args.data.hostid){ //添加hostid
            	//alert(args.data.hostid);
            	$.extend(deployVmData, {//de4a830c-5a0c-4e9f-9979-28966daf1cd7
