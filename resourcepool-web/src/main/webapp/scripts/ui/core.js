...
(function($, cloudStack) {
    ...
    var makeNavigation = function(args) {
        ...
        if(1==1){ //add by @ma     	    	
        	...
        	$navList.find("li.workOrderToDo").addClass(liClass).hide();
        	$navList.find("li.workOrderDue").addClass(liClass).hide();
        	$navList.find("li.workOrders").addClass(liClass).hide();
    ...
    var menuSlideToggle = function(sectionID) {
        ...
        if(sectionID=="workOrderMenu"){
        	if($("li.workOrderMenu").hasClass("toggle")){
        		$("li.workOrderMenu").removeClass("toggle");
        		cloudStack.openMenu = null;
        	}else{
        		menuSlideToggle(cloudStack.openMenu);
        		cloudStack.openMenu = "workOrderMenu";
	        	$("li.workOrderMenu").addClass("toggle");
        	}
        	$("li.workOrderToDo").slideToggle("fast");
        	$("li.workOrderDue").slideToggle("fast");
        	$("li.workOrders").slideToggle("fast");
        	return true;
        }
