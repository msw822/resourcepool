...
//            	            "network", "templates","system", "configuration","systemMenu","accounts", "domains", "regions","projects", "affinityGroups","global-settings","logMenu","events"];
            	sections = ["dashboard", "instances","workOrderMenu","workOrders","workOrderToDo","workOrderDue","resourceMenu", "storage", 
            	            "network", "templates","system", "configuration","systemMenu","accounts", "domains", "regions","projects", "affinityGroups","global-settings","logMenu","events","logs","statisticMenu", "resourceStatistics","workOrderReport","topData"];
            } else if (isDomainAdmin()) {
                sections = ["dashboard","instances","resourceMenu","storage", "network", "templates", "systemMenu","accounts", "domains","projects", "regions", "affinityGroups","workOrderMenu","workOrders","workOrderToDo","workOrderDue","logMenu","events"];
            } else if (g_userProjectsEnabled) {

                sections = ["dashboard","instances","resourceMenu","storage", "network", "templates","systemMenu", "accounts",  "projects", "regions", "affinityGroups","workOrderMenu","workOrders","workOrderToDo","workOrderDue","logMenu","events"];
            } else { //normal user
                sections = ["dashboard","instances","resourceMenu","storage", "network", "templates",  "systemMenu","accounts",  "regions", "affinityGroups","workOrderMenu","workOrders","workOrderToDo","workOrderDue","logMenu","events"];
            }
