                            ...
                            createForm: {
                                ...
                                fields: {
                                    ...
                                    instance: {
                                        ...
                                        validation: {//虚拟机必选项 add 06-29 mashaowei
                                            required: true
                                        }
                                    },
                                    diskOffering: {
...
//                                },
                                action: function(args) {
                                	...
                                	if(args.context.volumes[0].id !=null){
                                		$.extend(data,{
                                			diskid: args.context.volumes[0].id
                                    	});
                                		$.extend(data,{
                                			diskname: args.context.volumes[0].name
                                    	});
                                		$.extend(data,{
                                			odiskofferingid: args.context.volumes[0].diskofferingid
                                    	});
                                	}
//                                	if(args.context.instances[0].id !=null){
                                	if(args.context.instances[0]!=null){
                                		$.extend(data,{
                                			instancesid: args.context.instances[0].id
                                    	});
                                		$.extend(data,{
                                			instancesname: args.context.instances[0].name
                                    	});
                                		
                                	}
                                	$.extend(data,{
                                		shrinkok: args.data.shrinkok == "on"
                                	});
                                	var newDiskOffering = args.data.newdiskoffering;
                                	var newSize;
                                	if (selectedDiskOfferingObj.iscustomized == true) {
                                	...
                                	if (newDiskOffering != null && newDiskOffering.length > 0) {
                                		$.extend(data,{
                                			diskofferingid: todb(newDiskOffering)
                                    	});
                                	}
                                  if (newSize != null && newSize.length > 0) {
                                  	$.extend(data,{
                                  		diskSize: todb(newSize)
                                	});
                                  }
