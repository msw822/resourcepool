								...
								$
										.ajax({
											...
											success : function(data) {
												...
												$(window)
														.trigger(
																'cloudStack.fullRefresh');
											},
											error : function(data) {
												args.response
														.error(parseXMLHttpResponse(data));
											}
										});
							}
						},
						...
						actions : {
							...
							remove : {
								...
								action : function(args) {
									...
									$.ajax({
										url : createURL("deleteEvents&ids="
												+ args.context.events[0].id),
										success : function(json) {
											args.response.success();
											$(window).trigger(
													'cloudStack.fullRefresh');
							...
							archive : {
								...
								action : function(args) {
									...
									$.ajax({
										url : createURL("archiveEvents&ids="
												+ args.context.events[0].id),
										success : function(json) {
											args.response.success();
											$(window).trigger(
						...
						actions : {
							...
							remove : {
								...
								action : function(args) {
									...
									$.ajax({
										url : createURL("deleteAlerts&ids="
												+ args.context.alerts[0].id),
										success : function(json) {
											args.response.success();
											$(window).trigger(
													'cloudStack.fullRefresh');
							...
							archive : {
								...
								action : function(args) {
									...
									$.ajax({
										url : createURL("archiveAlerts&ids="
												+ args.context.alerts[0].id),
										success : function(json) {
											args.response.success();
											$(window).trigger(
